...
538 10 HTTPClient 0 4 813 22 HTTPClient::HTTPClient 0 2 136 137 22
/**
 *
 */
...
587 13 HTTPEntityTag 0 4 816 28 HTTPEntityTag::HTTPEntityTag 0 4 186 187 188 189 259
/**
 *
 */
...
599 14 ~HTTPEntityTag 0 4 816 29 HTTPEntityTag::~HTTPEntityTag 0 0 0
36
HTTPEntityTag::~HTTPEntityTag(void);

600 12 DocumentSpec 0 4 817 26 DocumentSpec::DocumentSpec 0 4 201 202 203 204 46
/**
 *
 */
...
623 13 ~DocumentSpec 0 4 817 27 DocumentSpec::~DocumentSpec 0 0 0
34
...
701 11 HTTPChannel 0 4 823 24 HTTPChannel::HTTPChannel 0 1 227 10
/**
 *
 */
63
...
702 12 Decompressor 0 4 826 26 Decompressor::Decompressor 0 2 305 306 10
/**
 *
 */
100
...
703 13 ~Decompressor 0 4 826 27 Decompressor::~Decompressor 0 0 10
/**
 *
 */
34
...
708 10 DownloadDb 0 4 829 22 DownloadDb::DownloadDb 0 4 313 314 315 316 170
/**
...
709 11 ~DownloadDb 0 4 829 23 DownloadDb::~DownloadDb 0 0 10
/**
 *
 */
30
...
757 9 Extractor 0 4 831 20 Extractor::Extractor 0 1 363 10
/**
 *
 */
27
...
758 10 ~Extractor 0 4 831 21 Extractor::~Extractor 0 0 10
/**
 *
 */
28
...
767 15 MultiplexStream 0 4 832 32 MultiplexStream::MultiplexStream 0 1 372 10
/**
 *
 */
46
...
774 16 ~MultiplexStream 0 4 832 33 MultiplexStream::~MultiplexStream 0 0 0
40
...
776 20 VirtualFileMountHTTP 0 4 835 42 VirtualFileMountHTTP::VirtualFileMountHTTP 0 1 380 10
/**
 *
 */
122
...
781 7 Patcher 0 4 837 16 Patcher::Patcher 0 3 385 386 387 22
/**
 *
 */
...
782 8 ~Patcher 0 6 837 17 Patcher::~Patcher 0 0 10
/**
 *
 */
32
...
786 12 StringStream 0 4 838 26 StringStream::StringStream 0 2 391 392 102
/**
 *
 */
...
791 13 ~StringStream 0 4 838 27 StringStream::~StringStream 0 0 0
34
 ...
 *
 */ 0 
36 0 0 7 57 863 495 0 0 1 6 param0 0 864  
37 0 0 7 57 863 495 0 135 /**
 * Creates a URLSpec by appending a path to the end of the old URLSpec,
 * inserting an intervening forward slash if necessary.
 */ 2 3 url 1 864  4 path 1 865  
38 0 0 7 57 863 495 0 10 /**
 *
 */ 2 3 url 1 868  20 server_name_expected 1 806  
 ...
 * server_name_expected is true, it is a hint that an undecorated URL is
 * probably a server name, not a local filename.
 */ 3 4 this 3 863  3 url 1 868  20 server_name_expected 1 806  
...
90 0 0 7 125 872 497 0 0 1 6 param0 0 873  
91 0 0 7 128 875 515 0 10 /**
 *
 */ 0 
92 0 0 7 128 875 515 0 10 /**
 *
 */ 1 4 copy 1 876  
93 0 0 7 128 875 515 0 122 /**
 * Decodes the string into a sensible date.  Returns 0 (!is_valid()) if the
 * string cannot be correctly decoded.
 */ 1 6 format 1 868  
94 0 0 7 128 875 515 0 10 /**
 *
 */ 1 4 time 1 877  
 ...
 * Constructs an empty cookie.
 */ 0 
113 0 0 7 147 879 517 0 0 1 6 param0 0 880  
 ...
 *
 */ 0 
187 0 0 7 229 886 599 0 10 /**
 *
 */ 1 4 copy 1 887  
188 0 0 7 229 886 599 0 99 /**
 * This constructor accepts an explicit weak flag and a literal (not quoted)
 * tag string.
 */ 2 4 weak 1 806  3 tag 1 868  
189 0 0 7 229 886 599 0 134 /**
 * This constructor accepts a string as formatted from an HTTP server (e.g.
 * the tag is quoted, with an optional W/ prefix.)
 */ 1 4 text 1 868  
 ...
 *
 */ 0 
202 0 0 7 243 888 623 0 10 /**
 *
 */ 1 4 copy 1 889  
203 0 0 7 243 888 623 0 10 /**
 *
 */ 1 3 url 1 864  
204 0 0 7 243 888 623 0 10 /**
 *
 */ 1 3 url 1 868  
 ...
 *
 */ 3 4 this 3 889  3 out 1 858  12 indent_level 1 846  
227 0 0 7 358 885 0 0 0 1 6 param0 0 891  
 ...
 * subdocument_resumes is false, a subdocument will always be downloaded
 * beginning at the first byte of the file.
 */ 3 4 this 3 885  8 filename 1 865  19 subdocument_resumes 1 806  
 ...
 * within the Ramfile for writing the output.  In this case, the Ramfile must
 * already have at least first_byte bytes in it.
 */ 3 4 this 3 885  7 ramfile 1 895  19 subdocument_resumes 1 806  
 ...
 * subdocument_resumes is false, a subdocument will always be downloaded
 * beginning at the first byte of the file.
 */ 3 4 this 3 885  4 strm 1 858  19 subdocument_resumes 1 806  
 ...
 *
 */ 0 
306 0 0 7 360 899 703 0 0 1 6 param0 0 900  
 ...
 * Primarily used for testing.
 */ 0 
314 0 0 7 371 902 709 0 0 1 6 param0 0 903  
 ...
 * Adds the indicated generic ostream to the multiplex output.  The ostream
 * will receive whatever data is sent to the pipe.
 */ 3 4 this 3 916  3 out 1 858  12 delete_later 1 806  
 ...
 *
 */ 0 
386 0 0 7 452 922 782 0 0 1 6 param0 0 923  
 ...
 *
 */ 0 
392 0 0 7 458 927 791 0 0 1 6 source 1 839  
 ...
 * Returns the number of characters available to be read from the data stream.
 */ 1 4 this 3 927  
395 0 0 6 461 839 0 0 63 /**
 * Returns the contents of the data stream as a string.
 */ 1 4 this 3 927  
396 0 0 4 462 845 0 0 0 2 4 this 3 927  4 data 1 839  
397 0 0 6 418 870 0 0 0 1 4 name 1 905  
398 0 0 6 419 870 0 0 0 1 4 name 1 905  
136
...
